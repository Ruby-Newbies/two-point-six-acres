Feature: functions regarding comments: add, get and delete comments
  ...
  Scenario: get comment list and detail
    ...
    When I send a get list request to comments api with article_ID 1
    Then I should receive a response with 1 comments
...
#    Then I click certain comment with ID of 1
  ...
  Scenario: post a request to delete an existing comment
  ...
  Scenario: post a request to delete an non-existing comment
    When I post a request to delete comment with comment_ID 6
